    ...
    <div className='ab-main'>
      <div className='ab-text'>
        ...
        <Text fontSize='md' color='white'>
          Hi! I&apos;m Brandon. I&apos;m a 24 year old from Vancouver, BC who&apos;s passionate about web development, film photography, and
          cooking. Take a look around my website for a glimpse into my hobbies and feel free to get in touch!
        </Text>
